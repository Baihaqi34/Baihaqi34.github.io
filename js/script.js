...
function didih() {
	let celcius = document.getElementById('celcius').value = "100";
	let fahrenheit = document.getElementById('fahrenheit').value = "212";
	let reamur = document.getElementById('reamur').value = "80";
	let kelvin = document.getElementById('kelvin').value = "373"; 
